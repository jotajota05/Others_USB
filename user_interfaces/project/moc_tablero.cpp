...
**
** Created: Thu Jul 9 09:33:34 2009
...
static const char qt_meta_stringdata_Tablero[] = {
    "Tablero\0"
};

const QMetaObject Tablero::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Tablero,
      qt_meta_data_Tablero, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tablero))
